//
//  GameScene.swift
//  Crashy Plane(Project38)
//
//  Created by Igor Tkach on 9/13/18.
//  Copyright © 2018 Igor Tkach. All rights reserved.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        //MARK: - Collide with ground and rocks
    ...
    func createPlayer() {
        ...
        //plane respond to physics! by defualt
    ...
    func createGround() {
        ...
        for i in 0...1 {
            ...
            let moverReset = SKAction.moveBy(x: groundTexture.size().width, y: 0, duration: 0)
            let moveLoop = SKAction.sequence([moveLeft,moverReset])
            let moveForever = SKAction.repeatForever(moveLoop)
    ...
    func createRocks() {
        ...
        //Box which determine the collision with plane and rock
        let rockCollision = SKSpriteNode(color: UIColor.clear,
        ...
        //Position rock in the right edge of the screen
